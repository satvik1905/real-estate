  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      ...
      <p className="mb-4 text-slate-700">
        Husky Estate is a leading real estate agency tailored for Northeastern
        University students, specializing in helping clients buy, sell, and rent
      ...
      <p className="mb-4 text-slate-700">
        At Husky Estate, we understand the unique needs of Northeastern
        University students. Whether you're looking for off-campus housing,
        investment properties, or rental options, we are here to support you
        with tailored solutions. Our deep connection with the Northeastern
        community allows us to offer insights and opportunities that perfectly
        match the lifestyle and expectations of Huskies.
      </p>
    </div>
  );
}
